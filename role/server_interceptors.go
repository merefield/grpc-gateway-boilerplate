...
// func (s *Server) rwlockUnaryIntercepter(
// 	ctx context.Context,
// 	req interface{},
...
// func (s *Server) rwlockStreamIntercepter(
// 	srv interface{},
...
// func (s *Server) loggerInterceptor(handler func() error, fullMethod string) error {
// 	reqid := uuid.New()
// 	log := logrus.New()
...
// func (s *Server) loggerServerUnaryInterceptor(
// 	ctx context.Context,
// 	req interface{},
// 	info *grpc.UnaryServerInfo,
// 	handler grpc.UnaryHandler,
...
// func (s *Server) loggerServerStreamInterceptor(
// 	srv interface{},
// 	stream grpc.ServerStream,
// 	info *grpc.StreamServerInfo,
// 	handler grpc.StreamHandler,
...
// func (s *Server) authorizationInterceptor(
// 	ctx context.Context,
// 	handler func() error,
// 	fullMethod string,
// ) error {
...
// 	// Get method and API
// 	reqService, reqAPI := s.GetMethodInformation(api.SdkRootPath, fullMethod)
...
// func (s *Server) authorizationServerUnaryInterceptor(
// 	ctx context.Context,
// 	req interface{},
// 	info *grpc.UnaryServerInfo,
// 	handler grpc.UnaryHandler,
...
// func (s *Server) authorizationServerStreamInterceptor(
// 	srv interface{},
// 	stream grpc.ServerStream,
// 	info *grpc.StreamServerInfo,
// 	handler grpc.StreamHandler,
