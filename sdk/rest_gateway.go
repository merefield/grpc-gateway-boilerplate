...
func (s *sdkRestGateway) restServerSetupHandlers() (http.Handler, error) {
	...
	handlers := []func(context.Context, *runtime.ServeMux, *grpc.ClientConn) (err error){
		...
		iam.RegisterResonateIAMHandler,
		api.RegisterResonateUserHandler,
		api.RegisterResonateMembershipHandler,
		api.RegisterResonateCredentialsHandler,
		api.RegisterResonateRoleHandler,
